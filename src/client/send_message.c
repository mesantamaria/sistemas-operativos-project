...
void send_message(int socket, char* message){
	...
	*/
	...
	int msgLen = calculate_length(message); //no se debería enviar en el payload el caracter nulo al final del input. Ojo que al imprimir el string sin este caracter les aparecerá un simbolo raro al final
	...
	package[0] = 19;
	package[1] = msgLen;
	strcpy(&package[2], message); //debería copiar hasta encontrar un caracter nulo, osea los msgLen caracteres
